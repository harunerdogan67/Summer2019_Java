...
public class WebTablesPractice {
    ...
    public void test5(){
        ...
        int index =1;
        List<WebElement> row=driver.findElements(By.xpath("//table[@id='table1']//tr["+index+"]//td"));
     ...
     *
     */
    @Test(description = "verify that every value contains '@' ")
    public void test7(){
        //get all emails
        //td[3] - means third column
        //we are skippingtr, because we need data
