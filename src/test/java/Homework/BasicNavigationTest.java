...
public class BasicNavigationTest {
    ...
    public void test3(){
        ...
        WebElement multiple = driver.findElement(By.linkText("Multiple Buttons"));
        multiple.click();
    ...
    @Test(description = "first name can only consist of alphabetical letters")
    public void test4(){
        BrowserUtils.wait(3);
    ...
    @Test(description = "The username must be more than 6 and less than 30 characters long")
    public void test6(){
        BrowserUtils.wait(3);
    ...
    @Test(description = "email address is not a valid or Email format is not correct")
    public void test7(){
        BrowserUtils.wait(3);
    ...
    @Test(description = "Phone format is not correct")
    public void test8(){
        BrowserUtils.wait(3);
